...
/*long press reboot function realize*/
	if(kpd_enable_lprst&& get_boot_mode() == NORMAL_BOOT) {
		...
		upmu_set_rg_ap_rst_dis(1); //disable rg watchdog reset
		upmu_set_rg_strup_man_rst_en(1);
		...
		upmu_set_rg_pwrkey_rst_en(1);
		upmu_set_rg_pwrkey_rst_en(0);//pmic_config_interface(TOP_RST_MISC, 0x01, PMIC_RG_PWRKEY_RST_EN_MASK, PMIC_RG_PWRKEY_RST_EN_SHIFT);
		//upmu_set_rg_homekey_puen(0x01);
		//upmu_set_rg_homekey_rst_en(0x00);
