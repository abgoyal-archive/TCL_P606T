...
int g_jeita_recharging_voltage=4260;
...
void ChargerHwInit_fan5405(void)
{
    ...
    if(temp_init_flag==0)
    {
        ...
        fan5405_config_interface_liao(0x05,0x04);
#ifdef SWITCH_CHARGER_UNSTANDARD_1A
        fan5405_config_interface_liao(0x04,0x6b);  //set Iterm to 194ma,set Iochr to 1150ma
#else
...
{    
	...
	// msleep(500);
	 printk("############msleep for update before wake_unlock#############\n");
