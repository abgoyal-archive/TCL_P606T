...
xmlHash["android.hardware.camera.front"] = ["android.hardware.camera.any","android.hardware.camera.front"]
xmlHash["android.hardware.camera.autofocus"] = ["android.hardware.camera","android.hardware.camera.autofocus"]
xmlHash["android.hardware.camera.flash-autofocus"] = ["android.hardware.camera.any","android.hardware.camera","android.hardware.camera.autofocus","android.hardware.camera.flash"]
