	...
	for (ssid = group; ssid; ssid = ssid->pnext) {
		...
		if (wpas_network_disabled(wpa_s, ssid)) {
			...
			continue;
                ...
                //PR383810 BEGIN---Change WIFI 3G fall back threshold---QIHONG.XU@TCL.COM---Jan 30,2013
		...
		//PR383810 END---Change WIFI 3G fall back threshold---QIHONG.XU@TCL.COM---Jan 30,2013
